...
See [CI/CD Integration](../ci-cd-integration/) for the complete reference of inputs and outputs.
...
To automatically re-run checks every time a file changes in the project:
...
See [Watch Mode](../watch-mode/) for complete documentation.
