...
description: "Common errors, quick fixes and frequently asked questions."
order: 20
...
| `completeness` | Requirement without a task that implements it |
...
Yes. See the [CI/CD integration](../verification/#integracion-con-cicd) section in the verification guide.
