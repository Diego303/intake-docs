---
title: "Plugins"
description: "Extensible plugin system with parsers, exporters and connectors."
order: 7
...
When intake loads a registry (`ParserRegistry`, `ExporterRegistry`), it tries to discover plugins first. If discovery fails, it falls back to manual registration (hardcoded).
...
V1 protocols are the original ones in the system. They are minimal and sufficient for simple parsers and exporters:
...
### Step 3: Register as entry_point
