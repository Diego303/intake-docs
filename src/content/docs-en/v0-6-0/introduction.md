...
**intake** is an open-source CLI tool that transforms requirements from multiple sources and formats (Jira, Confluence, GitHub, GitLab, PDFs, Markdown, YAML, images, DOCX, free text) into a normalized and verifiable specification that any AI agent can consume.
...
| [CLI Guide](../cli-guide/) | Complete reference of all 22 commands/subcommands with all their options |
...
| [Input Formats](../input-formats/) | The 12 parsers + 4 API connectors, what they extract and how they auto-detect |
...
| [Security](../security/) | Threat model, secret management, redaction, compliance |
...
# 13. Watch mode: re-verify when files change
intake watch specs/payment-gateway/ --project-dir . --verbose

# 14. Validate internal consistency of a spec
intake validate specs/payment-gateway/

# 15. Estimate cost before generating
intake estimate -s requirements.md -s notes.md

# 16. Generate CI config for verification
intake export-ci specs/payment-gateway/ -p gitlab
```
