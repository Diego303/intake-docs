...
Direct API connectors allow fetching data from Jira, Confluence, and GitHub without manually exporting files. They are used via scheme URIs in the `-s` flag.
