---
title: "CLI Guide"
description: "Complete reference for all commands with all their options."
order: 3
...
intake provides 15 commands and subcommands. All follow the pattern:
...
| Flag | Short | Type | Default | Description |
|------|-------|------|---------|-------------|
| `--dir` | `-d` | path | `./specs` | Directory where to search for specs. |
