...
│   ├── loader.py            #   Layer merge: defaults -> preset -> YAML -> CLI
...
│   └── hooks.py             #   Pipeline hooks system (HookManager)
...
│   └── spec_updater.py      #   SpecUpdater: preview + apply spec amendments
...
└── utils/                  # Shared utilities
    ...
    ├── project_detect.py    #   Auto-detection of the technology stack
