...
│   │   └── notification-service/   # Notifications spec
│   ├── frontend/
...
See [Security > Auditing and traceability](../security/#auditing-and-traceability) for more details.
