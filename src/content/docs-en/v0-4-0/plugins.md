...
When intake loads a registry (`ParserRegistry`, `ExporterRegistry`), it attempts plugin discovery first. If discovery fails, it falls back to manual registration (hardcoded).
