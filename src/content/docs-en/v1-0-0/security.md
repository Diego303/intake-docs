---
title: "Security"
description: "Threat model, secrets management, redaction, compliance."
order: 15
...
| Spec access control | Depends on the file system / git |
...
- [ ] `spec.lock.yaml` committed alongside the specs
