---
title: "Feedback Loop"
description: "Feedback loop: failure analysis and spec amendments."
order: 11
...
4. Sends the failures + context to the LLM for root cause analysis
...
|-------|------|---------|-------------|
| `auto_amend_spec` | bool | `false` | If `true`, applies amendments without requiring `--apply`. |
| `max_suggestions` | int | `10` | Limits the number of suggestions from the LLM. |
