---
title: "Workflows"
description: "Patterns for teams of all sizes: individual to enterprise."
order: 12
...
Usage patterns for intake across different team scales and organization levels, from an individual developer to multi-team enterprises with regulatory requirements.
...
5. Team implements using verified spec
         ↓
6. CI runs intake verify on every PR
         ↓
...
│   │   └── notification-service/   # Notification spec
│   ├── frontend/
...
# 5. If there are failures, analyze them
...
For industries that require traceability (finance, healthcare, government):
...
export:
  default_format: generic          # Consolidated SPEC.md as a formal document
```
...
See [Security > Audit and traceability](../security/#audit-and-traceability) for more details.
