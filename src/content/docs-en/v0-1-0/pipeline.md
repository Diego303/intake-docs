...
1. The **Registry** receives the file path
2. **Auto-detects the format** by extension and content:
   ...
   - Fallback: plaintext
3. **Selects the parser** registered for that format
4. The parser produces a normalized **`ParsedContent`**
