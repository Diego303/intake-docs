---
title: "Verificación"
description: "Sistema de verificación para validar que el código cumple la spec."
order: 8
...
Ver [Integracion CI/CD](../ci-cd-integration/#action-oficial-de-intake-recomendado) para la referencia completa de inputs y outputs.
...
Ver [MCP Server](../mcp-server/) para detalles.
