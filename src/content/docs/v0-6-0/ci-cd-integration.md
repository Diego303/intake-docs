...
description: "GitHub Actions, GitLab CI, Jenkins y Azure DevOps con intake."
order: 13
...
**Nota:** `export-ci` usa templates Jinja2 built-in (`gitlab_ci.yml.j2`, `github_actions.yml.j2`). Si necesitas customizarlos, puedes sobreescribirlos con [templates de usuario](../configuration/#seccion-templates).
