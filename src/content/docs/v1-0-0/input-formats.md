...
description: "Los 12 parsers + 4 conectores API, qué extraen y cómo se auto-detectan."
order: 6
...
intake soporta 12 formatos de entrada a traves de parsers especializados. El formato se auto-detecta por extension de archivo y contenido. Los parsers se descubren automaticamente via el [sistema de plugins](../plugins/).
...
Ver [Configuracion > Conectores](../configuration/#seccion-connectors) para los campos de configuracion completos. Los conectores necesitan:
