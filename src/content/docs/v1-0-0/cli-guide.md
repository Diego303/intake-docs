---
title: "Guía CLI"
description: "Referencia completa de los 22 comandos y subcomandos con opciones y ejemplos."
order: 3
...
4. **Resolucion de fuentes**: cada fuente se resuelve via `parse_source()`:
   ...
   - URIs de esquema (`jira://`, `confluence://`, `github://`, `gitlab://`) → se resuelven via conectores API (ver [Conectores](../connectors/))
