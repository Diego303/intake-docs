...
| Campo | Tipo | Descripción |
|-------|------|-------------|
| `glob` | string | Patrón glob para encontrar archivos (ej: `src/**/*.py`) |
...
| Campo | Tipo | Descripción |
|-------|------|-------------|
| `glob` | string | Patrón glob para encontrar archivos |
...
|-------|------|---------|-------------|
| `id` | string | `"unknown"` | Identificador único del check |
